package timepicker.test.com.testsingledateandtimepicker.singledateandtimepicker.dialog;
...
//            MyLog.Log("defaultDate in Dialog: " + defaultDate);
        }
        ...
        if (defaultDate != null) {
            // update on 5/11/2018 by tusinh
            for (WheelPicker picker : picker.pickers) {
                picker.setDefaultDate(defaultDate);
            }
        }
