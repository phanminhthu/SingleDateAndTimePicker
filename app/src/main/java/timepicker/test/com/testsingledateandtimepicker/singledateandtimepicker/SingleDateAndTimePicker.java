package timepicker.test.com.testsingledateandtimepicker.singledateandtimepicker;
...
import timepicker.test.com.testsingledateandtimepicker.R;
import timepicker.test.com.testsingledateandtimepicker.singledateandtimepicker.widget.WheelAmPmPicker;
import timepicker.test.com.testsingledateandtimepicker.singledateandtimepicker.widget.WheelDayOfMonthPicker;
import timepicker.test.com.testsingledateandtimepicker.singledateandtimepicker.widget.WheelDayPicker;
import timepicker.test.com.testsingledateandtimepicker.singledateandtimepicker.widget.WheelHourPicker;
import timepicker.test.com.testsingledateandtimepicker.singledateandtimepicker.widget.WheelMinutePicker;
import timepicker.test.com.testsingledateandtimepicker.singledateandtimepicker.widget.WheelMonthPicker;
import timepicker.test.com.testsingledateandtimepicker.singledateandtimepicker.widget.WheelPicker;
import timepicker.test.com.testsingledateandtimepicker.singledateandtimepicker.widget.WheelYearPicker;

import static timepicker.test.com.testsingledateandtimepicker.singledateandtimepicker.DateHelper.getCalendarOfDate;


/*source:https://github.com/florent37/SingleDateAndTimePicker*/
...
//                MyLog.Log("MONTH: "+monthPicker.getCurrentMonth());
            }

            if (displayYears) {
                calendar.set(Calendar.YEAR, yearsPicker.getCurrentYear());
//                MyLog.Log("YEAR: "+yearsPicker.getCurrentYear());
            }

            if (displayDaysOfMonth) {
                calendar.set(Calendar.DAY_OF_MONTH, daysOfMonthPicker.getCurrentDay() + 1);
//                MyLog.Log("DAY_OF_MONTH: "+daysOfMonthPicker.getCurrentDay()+ 1);
            }
        }
